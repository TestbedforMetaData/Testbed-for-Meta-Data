...
INSERT INTO `answers` VALUES (1,1,'',34,0,1,1),(2,2,'I am Murat',-1,0,1,2),(3,4,'',-1,1,1,3),(4,1,'',36,0,2,2),(5,4,'',-1,1,2,1),(8,4,'',-1,1,6,1),(9,1,'',35,0,6,2),(10,4,'',-1,1,7,1),(11,1,'',36,0,7,2),(12,2,'User ABC',-1,0,7,3);
...
INSERT INTO `compilation_parts` VALUES (2,3,2,'Question',5),(3,3,7,'Document',3),(4,3,4,'Question',2),(5,3,1,'Question',4),(6,4,2,'Document',1),(7,4,4,'Question',2),(8,4,6,'Document',3),(9,4,1,'Question',4),(42,9,2,'Document',1),(43,9,1,'Question',2),(44,9,2,'Question',3),(45,3,2,'Document',1);
...
INSERT INTO `compilations` VALUES (3,'Test Compilation 1',1),(4,'Comp 2',1),(9,'Test 5',0);
...
INSERT INTO `multiple_answers` VALUES (1,5,3),(2,6,3),(3,5,5),(4,6,5),(5,7,5),(6,5,8),(7,7,8),(8,5,10),(9,6,10);
...
INSERT INTO `subjects` VALUES (1,'Murat'),(2,'Test'),(6,'Test User'),(7,'ABC');
...
-- Dump completed on 2015-12-08 14:02:40
